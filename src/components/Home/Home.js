...
import { totalMovieWatchTime, totalTVWatchTime, totalWatchTime, getCurrentFriends, movieGenreCounts} from '../../services/database';
...
function Home() {
  ...
  useEffect(() => {
    ...
    if(!isNaN(watchTime.totalWatchTime[0].total_runtime)){
    ...
    <>
      ...
      <div>
          ...
          <div className="content">
            ...
            <div className="card-long card5" onClick={()=>navigate('/repository')}>
              <div className="card-label">Recommended &amp; Suggested</div>
            </div>
            <div className="card-long card6" onClick={()=>navigate('/repository')}>
